...
import { ArrowLeft, Send, FileText, AlertCircle, Lightbulb, MessageSquare, Flag } from "lucide-react"
...
const contributionTypes = [
  { value: "suggestion", label: "Sugestão", icon: Lightbulb, color: "bg-blue-100 text-blue-800" },
  { value: "correction", label: "Correção", icon: AlertCircle, color: "bg-red-100 text-red-800" },
  { value: "question", label: "Pergunta", icon: MessageSquare, color: "bg-yellow-100 text-yellow-800" },
  { value: "concern", label: "Preocupação", icon: Flag, color: "bg-orange-100 text-orange-800" },
]
...
export default function ContributePage({ params }: { params: { id: string } }) {
  ...
  const selectedType = contributionTypes.find((type) => type.value === formData.type)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Nova Contribuição</h2>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Forneça informações detalhadas sobre sua sugestão, correção ou comentário
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Seja específico e forneça contexto. Inclua sugestões de melhoria quando possível.
                  </p>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {formData.section && <Badge variant="outline">{formData.section}</Badge>}
                  {formData.priority && (
                ...
                {formData.content && (
                  <div>
                    <p className="text-sm text-muted-foreground line-clamp-4">{formData.content}</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Indique exatamente qual parte precisa ser alterada</p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Explique por que a mudança é necessária</p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Quando possível, proponha alternativas</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                ...
                <p className="text-muted-foreground">23 contribuições existentes</p>
