...
const contributions = [
  ...
  },
  {
    ...
    content:
      "Encontrei um erro de digitação na seção 5.1: 'direitos do utilizadors' deveria ser 'direitos dos utilizadors'.",
    user: {
      name: "João Santos",
      avatar: "/placeholder.svg?height=40&width=40",
      role: "Revisor",
  ...
  },
  {
    ...
    content:
      "Algumas partes do documento usam linguagem muito técnica que pode ser difícil para utilizadors comuns entenderem. Sugiro simplificar a linguagem em certas seções.",
    user: {
      name: "Lucia Ferreira",
      avatar: "/placeholder.svg?height=40&width=40",
      role: "UX Writer",
...
export default function ContributionsPage({ documentId }: Props) {
